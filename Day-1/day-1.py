...
def part2(lines) -> int:
    ...
    digit_dict = {"one": "1", "two": "2", "three": "3", "four": "4", "five": "5", "six": "6",
    ...
    for line in lines:
        ...
        first_digit = digit_dict.get(first_digit_match.group(1), first_digit_match.group(1))

        last_digit_match = first_digit_match
        for last_digit_match in digit_iter:
            pass
        last_digit = digit_dict.get(last_digit_match.group(1), last_digit_match.group(1))
